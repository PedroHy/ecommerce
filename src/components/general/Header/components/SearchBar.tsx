...
export default function SearchBar() {
    ...
    return (
        <div className='flex flex-col relative'>
            <div className={productsFiltred.length==0?'hidden':'bg-zinc-100 w-96 absolute top-9 flex flex-col pt-1'}>
            ...
            <div className='hidden items-center md:flex relative'>
                ...
                <div className='h-10 p-2 absolute text-zinc-500 right-0'> <MagnifyingGlass size={24} weight="bold" /> </div>
            </div>
        </div>
    )
}